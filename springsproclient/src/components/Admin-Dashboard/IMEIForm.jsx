...
//   shippingInfos,
//   carrierInfos,
//   accountFields, // Pass account fields
//   setAccountFields
// }) {
...
//       updatedAccounts[index].shippingAddress = value; // Update the entire shippingAddress object
//     } else {
//       updatedAccounts[index][field] = value; // Update the specific field
//     }
...
//                         value={account.shippingAddress.address}
//                         onChange={(e) => handleFieldChange(index, "shippingAddress", { ...account.shippingAddress, address: e.target.value })}
//                         className="w-full inter text-sm p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400"
//                       />
//                     </div>
//                     <div>
//                       <label className="block inter text-sm font-medium text-gray-700 mb-2">Attention Name</label>
//                       <input
//                         type="text"
//                         placeholder="Enter Attention Name"
//                         value={account.shippingAddress.attentionName}
//                         onChange={(e) => handleFieldChange(index, "shippingAddress", { ...account.shippingAddress, attentionName: e.target.value })}
//                         className="w-full inter text-sm p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400"
//                       />
//                     </div>
//                   </div>
...
function IMEIForm({
  ...
  const handleNumRowsChange = (e) => {
    ...
    const newFields = Array.from({ length: parsedValue }, () => ({
      portOutPin: "",
      phoneNumber: "",
      carrier: "",
      imei: "",
  ...
  return (
    <div>
      <div className="flex items-center justify-center gap-4 mb-4">
        ...
        <button type="button"
          onClick={handleModalOpen}
          className="bg-teal-500 text-white px-6 py-2 rounded font-bold"
        >
          Generate
        </button>
      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-4/5 lg:w-3/4 p-6 relative z-60 max-h-[80vh] overflow-y-auto">
            <button type="button"
            ...
            <h2 className="text-3xl font-bold text-center mb-6">Add IMEI and Account Information</h2>
                ...
                <div key={index} className="space-y-4 mb-8 p-6 bg-gray-50 rounded-lg shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <select
                        value={account.shippingAddress.attentionName} // Pre-select the current shipping address
                        onChange={(e) => {
                          const selectedAddress = shippingInfos.find(info => info.shippingaddress === e.target.value);
